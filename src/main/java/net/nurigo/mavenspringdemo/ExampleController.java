...
public class ExampleController {
    ...
    public ExampleController() {
        this.messageService = NurigoApp.INSTANCE.initialize("NCSWA6JF3ZIAZEZQ", "UCLVBF51YFVWUX63PFQKLBTUBBVNZWBU", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01040742070");
        message.setTo("01040742070");
